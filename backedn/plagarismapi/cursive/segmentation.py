...
#            print area
            if area > 10000:
                ...
                cv.imwrite("plagarismapi/cursive/result/words/" + str(counter) +".jpg",letterBgr)
                counter=counter+1
        cl=cl+1
...
def segmentation(img):
    try:
        ...
        img2 = cv.imread('plagarismapi/cursive/sample_images/c.png')
#        path='./result/'
    ...
    ###------------------------Visualize segmentation------------------------------#####        
            ...
            for i in wordImgList:
                cv.imwrite("plagarismapi/cursive/result/characters/" + str(counter) +".jpeg",i)
                counter=counter+1
